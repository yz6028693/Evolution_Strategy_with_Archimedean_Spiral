...
However, in the first version of the script, I found that in many times, when the Evolution Strategy developped a 'minority groups' (A group of points which population is relatively small), it tends to fade away though time and can't find the blue points they are closed to. And as we all know, sometimes the truth may be held in a handful of persons' hands. To pretect them from easily disappearing， I developed the second version of the script which dynamically cluster them based on their distance, and consider them as sepereate groups to evolve in the future. It's kind of like the population subdivision in real life.
